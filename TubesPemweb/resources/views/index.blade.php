...
<body>
	<br>
		...
		<center>
            <a href="{{ url('create') }}"> Buat Laporan/Komentar 
	...
	@php($selengkapnya = substr($lprn->isi_laporan,0,1000))

	<div class="body2">
		
		<p>{{$selengkapnya}}</p>
		<p>Lampiran: {{$lprn->lampiran_laporan}} <span>Waktu : {{$lprn->tgl_laporan}} &nbsp&nbsp <a href="{{url('/show/'.$lprn->id)}}">Lihat Selengkapnya ></a></span></p>
        <hr>
	</div>
